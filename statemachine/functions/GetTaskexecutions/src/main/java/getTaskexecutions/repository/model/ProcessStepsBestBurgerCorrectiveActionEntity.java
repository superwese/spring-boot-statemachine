...
import getTaskexecutions.repository.types.CorrectiveActionType;
...
@Entity
@Table(name = "process_steps_best_burger_corrective_action")
@Generated(value = "JPAGenerator")
public class ProcessStepsBestBurgerCorrectiveActionEntity extends ImmutableEntity {
    ...
    @ElementCollection
    @CollectionTable(name = "process_step_corrective_actions", joinColumns = @JoinColumn(name = "process_steps_best_burger_corrective_action_uuid"))
    @Enumerated(EnumType.STRING)
    @OrderColumn(name="sequence_number")
    @Column(name = "corrective_action_type")
    private List<CorrectiveActionType> correctiveActions;
    ...
    public List<CorrectiveActionType> getCorrectiveActions() {
        return correctiveActions;
    }

    public void setCorrectiveActions(List<CorrectiveActionType> correctiveActions) {
