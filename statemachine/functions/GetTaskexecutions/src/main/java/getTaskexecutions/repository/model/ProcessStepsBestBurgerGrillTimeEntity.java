...
@Entity
@Table(name = "process_steps_best_burger_grill_time")
@Generated(value = "JPAGenerator")
public class ProcessStepsBestBurgerGrillTimeEntity extends ImmutableEntity {
    ...
    //Grill Duration
    @Column(name = "grill_duration")
    private Integer grillDuration;
    ...
    public Integer getGrillDuration() {
        return grillDuration;
    }

    public void setGrillDuration(Integer grillDuration) {
        this.grillDuration = grillDuration;
    }
}
