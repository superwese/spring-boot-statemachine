...
@Entity
@Table(name = "process_steps_best_burger_patty_type")
@Generated(value = "JPAGenerator")
public class ProcessStepsBestBurgerPattyTypeEntity extends ImmutableEntity {
    ...
    //Product
    @Column(name = "max_run_size")
    private Integer maxRunSize;
    ...
    public Integer getMaxRunSize() {
        return maxRunSize;
    }

    public void setMaxRunSize(Integer maxRunSize) {
