...
@Entity
@Table(name = "process_steps_best_burger_questions")
@Generated(value = "JPAGenerator")
public class ProcessStepsBestBurgerQuestionEntity extends ImmutableEntity {
    ...
    //Question
    @Column(name = "product_answer")
    private String productAnswer;

    @Column(name = "equipment_answer")
    private String equipmentAnswer;

    @Column(name = "procedure_answer")
    ...
    public String getEquipmentAnswer() {
        return equipmentAnswer;
    }

    public void setEquipmentAnswer(String equipmentAnswer) {
        this.equipmentAnswer = equipmentAnswer;
    }

    public String getProcedureAnswer() {
        return procedureAnswer;
    }

    public void setProcedureAnswer(String procedureAnswer) {
        this.procedureAnswer = procedureAnswer;
    }
}
