...
@Entity
@Table(name = "process_steps_best_burger_result")
@Generated(value = "JPAGenerator")
public class ProcessStepsBestBurgerResultEntity extends ImmutableEntity {
    ...
    @Column(name = "safety_fail_count")
    private Integer safetyFailCount;
    ...
    public Integer getQualityFailCount() {
        return qualityFailCount;
    }

    public void setQualityFailCount(Integer qualityFailCount) {
        this.qualityFailCount = qualityFailCount;
    }

    public Integer getSafetyFailCount() {
        return safetyFailCount;
    }

    public void setSafetyFailCount(Integer safetyFailCount) {
        this.safetyFailCount = safetyFailCount;
    }
}
